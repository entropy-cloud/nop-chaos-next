...
const baseEvents: DashboardEvent[] = [
  {
    id: 'evt-1',
    timestamp: '2026-03-30 10:22',
    type: 'error',
    description: '模型网关出现间歇性超时，自动切换至备用池。',
    scope: 'AI 推理集群',
    status: '处理中',
  },
  {
    id: 'evt-2',
    timestamp: '2026-03-30 09:48',
    type: 'warning',
    description: '插件 Demo 上报频率提升，接近预警阈值。',
    scope: '插件容器 / 报表模块',
    status: '观察中',
  },
  {
    ...
    type: 'success',
    description: '订单工作流 v2.1 已发布并同步至生产影子环境。',
    scope: 'Flow Editor',
    status: '已完成',
  },
  {
    id: 'evt-4',
    timestamp: '2026-03-29 18:05',
    type: 'success',
    description: '主子表批量导出任务完成，共生成 124 个文件。',
    scope: '数据管理',
    status: '已完成',
  },
  {
    id: 'evt-5',
    timestamp: '2026-03-29 16:12',
    type: 'warning',
    description: '华东区物流接口出现 3 次重试。',
    scope: '物流服务',
    status: '已恢复',
  },
  {
    id: 'evt-6',
    timestamp: '2026-03-29 14:36',
    type: 'error',
    description: '地址表单校验规则与后端版本不一致。',
    scope: '订单详情 / 地址子表',
    status: '待确认',
  },
];
...
export async function fetchDashboardData(
  ...
  const previousRate =
    previousRequests === 0
      ? successRate
      : (previous.reduce((sum, item) => sum + item.success, 0) / previousRequests) * 100;
