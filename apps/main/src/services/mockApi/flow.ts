...
function createFlowNodePayload(
  kind: FlowNodeKind,
    ...
    nodes: [
      {
        ...
        type: 'start',
        position: { x: 80, y: 180 },
        data: createFlowNodePayload('start', { trigger: '注册成功' }, '开始', '流程入口'),
      },
      {
        id: 'task-1',
        type: 'task',
        position: { x: 300, y: 180 },
        data: createFlowNodePayload(
          'task',
          { channel: 'email', timeout: '30s' },
          '发送欢迎邮件',
          '邮件通知',
        ),
      },
      ...
      },
      {
        ...
        data: createFlowNodePayload('end', { result: 'completed' }, '结束', '流程出口'),
      },
    ],
    edges: [
      {
        ...
        data: { condition: '触发后', lineStyle: 'solid' },
        label: '触发',
      },
      {
        id: 'e-2',
        ...
        type: 'smoothstep',
        markerEnd: { type: 'arrowclosed' },
        data: { condition: '发送成功', lineStyle: 'solid' },
        label: '成功',
      },
      {
        id: 'e-3',
        ...
        type: 'smoothstep',
        markerEnd: { type: 'arrowclosed' },
        data: { condition: '是', lineStyle: 'dashed' },
        label: '企业客户',
      },
      {
        id: 'e-4',
        ...
        type: 'smoothstep',
        markerEnd: { type: 'arrowclosed' },
        data: { condition: '否', lineStyle: 'dotted' },
        label: '普通客户',
      },
      {
        id: 'e-5',
        ...
        type: 'smoothstep',
        markerEnd: { type: 'arrowclosed' },
        data: { condition: '完成', lineStyle: 'solid' },
        label: '完成',
      },
      {
        id: 'e-6',
        ...
        type: 'smoothstep',
        markerEnd: { type: 'arrowclosed' },
        data: { condition: '资料完整', lineStyle: 'solid' },
        label: '完成',
      },
    ],
  },
        ...
        nodes: [
          {
            ...
            data: createFlowNodePayload('start', { trigger: 'manual' }, '开始', '流程入口'),
          },
          {
            id: 'end-1',
            type: 'end',
            position: { x: 480, y: 180 },
            data: createFlowNodePayload('end', { result: 'done' }, '结束', '流程出口'),
          },
        ],
        edges: [
          {
