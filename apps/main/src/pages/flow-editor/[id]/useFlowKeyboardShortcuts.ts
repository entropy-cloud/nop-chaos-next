...
export function useFlowKeyboardShortcuts({
  ...
  }, [applyState, clipboardNode, edges, handleRedo, handleUndo, nodes, requestDelete, selectedEdgeId, selectedNode, selectedNodeId, setClipboardNode, setSelectedNodeId, t])
}
