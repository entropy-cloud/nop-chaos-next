  ...
  return (
    <>
      <Sheet open={propertyOpen} onOpenChange={setPropertyOpen}>
        <SheetContent
          side="right"
          className="w-[30rem] max-w-[92vw] border-l border-[hsl(var(--border))] bg-background shadow-xl sm:max-w-[30rem]"
        >
          <SheetHeader>
      ...
      <Sheet open={edgePanelOpen} onOpenChange={setEdgePanelOpen}>
        <SheetContent
          side="right"
          className="w-[26rem] max-w-[92vw] border-l border-[hsl(var(--border))] bg-background shadow-xl sm:max-w-[26rem]"
        >
          <SheetHeader>
