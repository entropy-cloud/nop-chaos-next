...
export function createNode(kind: FlowNodeKind, position: XYPosition, seed?: Partial<FlowNode['data']>): FlowNode {
...
export function flowEditorTestUtils() {
  return { createNode, normalizeEdge, createFlowStateSnapshot, getEdgeStyle, shouldRecordNodeChangeHistory, shouldRecordEdgeChangeHistory }
}
