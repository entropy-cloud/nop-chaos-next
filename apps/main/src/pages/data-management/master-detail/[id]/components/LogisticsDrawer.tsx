import { Button, Drawer, DrawerContent, DrawerDescription, DrawerFooter, DrawerHeader, DrawerTitle, Input, Label, Textarea } from '@nop-chaos/ui'
...
export function LogisticsDrawer({ open, onOpenChange, editingLogistics, setEditingLogistics, saveLogistics }: LogisticsDrawerProps) {
