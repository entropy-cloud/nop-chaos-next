...
import { ForbiddenPage, LoginPage, NotFoundPage, ServerErrorPage } from './page-registry';

const AppShell = lazy(() => import('./app-shell').then((module) => ({ default: module.AppShell })));
