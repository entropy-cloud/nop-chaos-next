  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" side="top" sideOffset={8} className="w-64">
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem data-testid="sidebar-user-menu-settings" onClick={() => handleNavigate('/settings')}>
          <Settings2 className="size-4" />
          {t('settings.title')}
        </DropdownMenuItem>
        <DropdownMenuItem data-testid="sidebar-user-menu-theme" onClick={() => handleNavigate('/settings/theme')}>
          <Palette className="size-4" />
          {t('settings.themeTitle')}
        </DropdownMenuItem>
        <DropdownMenuItem data-testid="sidebar-user-menu-language" onClick={() => handleNavigate('/settings/language')}>
        ...
        <DropdownMenuSeparator />
        <DropdownMenuItem data-testid="sidebar-user-menu-logout" variant="destructive" onClick={onLogout}>
