  ...
  persist(
    (set) => ({
      ...
      setSidebarCollapsedWidthRem: (value) =>
        set(() => ({
          sidebarCollapsedWidthRem: clampSidebarWidth(value, layoutConfig.sidebarCollapsedWidthRem, 4, 8)
        })),
      setWorkspaceFullscreen: (value) => set(() => ({ workspaceFullscreen: value })),
      toggleWorkspaceFullscreen: () => set((state) => ({ workspaceFullscreen: !state.workspaceFullscreen })),
      resetSidebarWidths: () =>
        set(() => ({
          sidebarWidthRem: layoutConfig.sidebarWidthRem,
          sidebarCollapsedWidthRem: layoutConfig.sidebarCollapsedWidthRem
