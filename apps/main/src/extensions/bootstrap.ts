...
import { registerThemes } from '../config/theme-registry'
import { registerHostSharedModules } from '../plugins/shared-modules'
import { registerBuiltinPages } from '../router/page-registry'
