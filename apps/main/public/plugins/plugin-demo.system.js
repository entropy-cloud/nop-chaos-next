          ...
          const kpiCards = [
            {
              ...
              icon: /* @__PURE__ */ jsx(Orbit, { className: 'size-4' }),
            },
            {
              label: t('plugins.currentUser'),
              value: user?.nickname ?? user?.username ?? t('common.guest'),
              icon: /* @__PURE__ */ jsx(UserRound, { className: 'size-4' }),
            },
            {
              label: t('plugins.currentLanguage'),
              value: i18n.language,
              icon: /* @__PURE__ */ jsx(Blocks, { className: 'size-4' }),
            },
            {
            ...
            children: [
              /* @__PURE__ */ jsxs(Card, {
                ...
                children: [
                  /* @__PURE__ */ jsxs(CardHeader, {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs('div', {
                        children: [
                          /* @__PURE__ */ jsx('div', {
                            className: 'eyebrow-text tracking-[0.22em]',
                            children: t('plugins.remotePluginEyebrow'),
                          }),
                          /* @__PURE__ */ jsx(CardTitle, { className: 'mt-3', children: title }),
                          /* @__PURE__ */ jsx('div', {
                            className: 'mt-2 text-sm text-muted-foreground',
                            children: t('plugins.placeholder'),
                          }),
                        ],
                      }),
                      /* @__PURE__ */ jsxs('div', {
                  ...
                  /* @__PURE__ */ jsx(CardContent, {
                    ...
                    children: kpiCards.map((item) =>
                      /* @__PURE__ */ jsxs(
                        'div',
                        {
                          className:
                            'rounded-xl border border-[hsl(var(--border))] bg-white/40 p-5 text-sm backdrop-blur-xl dark:bg-slate-900/35',
                          children: [
                            /* @__PURE__ */ jsxs('div', {
                              className:
                ...
                children: [
                  /* @__PURE__ */ jsx(CardHeader, {
                    children: /* @__PURE__ */ jsx(CardTitle, {
                      children: t('plugins.analyticsTitle'),
                    }),
                  }),
                  /* @__PURE__ */ jsxs(CardContent, {
                    ...
                    children: [
                      /* @__PURE__ */ jsx('div', {
                        ...
                        className:
                          'h-[20rem] overflow-hidden rounded-lg border border-[hsl(var(--border))] bg-white/35 p-3 dark:bg-slate-900/35',
                      ...
                      /* @__PURE__ */ jsx('div', {
                        ...
                        children: [
                          {
                            label: t('plugins.weekdays.mon'),
                            value: t('plugins.reportCount', { count: 16 }),
                          },
                          {
                            label: t('plugins.weekdays.thu'),
                            value: t('plugins.reportCount', { count: 25 }),
                          },
                          {
                            label: t('plugins.weekdays.sun'),
                            value: t('plugins.reportCount', { count: 30 }),
                          },
                        ].map((item) =>
                          /* @__PURE__ */ jsxs(
                            'div',
                            {
                              className:
                                'rounded-md border border-[hsl(var(--border))] bg-white/40 p-4 dark:bg-slate-900/35',
                              children: [
                                /* @__PURE__ */ jsx('div', {
                                  className: 'eyebrow-text text-muted-foreground',
                                  children: item.label,
                                }),
                                /* @__PURE__ */ jsx('div', {
              ...
              /* @__PURE__ */ jsxs(Card, {
                ...
                children: [
                  /* @__PURE__ */ jsx(CardHeader, {
                    children: /* @__PURE__ */ jsx(CardTitle, {
                      children: t('plugins.bridgeTitle'),
                    }),
                  }),
                  /* @__PURE__ */ jsxs(CardContent, {
                    className: 'grid gap-4 md:grid-cols-[1fr_0.9fr] text-sm text-muted-foreground',
                    children: [
                      /* @__PURE__ */ jsx('div', {
                        className:
                          'rounded-xl border border-[hsl(var(--border))] bg-white/40 p-5 backdrop-blur-xl dark:bg-slate-900/35',
                        children: t('plugins.bridgeDescription'),
                      }),
                      /* @__PURE__ */ jsx('div', {
                        className:
                          'rounded-xl border border-dashed border-[hsl(var(--border))] p-5',
                        children: t('plugins.bridgeState', {
