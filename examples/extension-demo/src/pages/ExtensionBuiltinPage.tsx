...
const highlights = [
  ...
  },
  {
    ...
    description: 'Registers a React component directly into the host builtin page registry through the extension loader.',
      ...
      <Card className='theme-card overflow-hidden border-none extension-hero'>
        <CardHeader className='space-y-3'>
          ...
          <p className='max-w-3xl text-sm text-muted-foreground'>
            This page is compiled inside the extension project, but it reuses the host theme tokens, UI base styles,
            and Tailwind preset. The host only needs to inject the extension CSS and register the component.
          </p>
        </CardHeader>
        ...
        <Card className='theme-card border-none'>
          ...
          <CardContent className='space-y-4 text-sm text-muted-foreground'>
            <div className='rounded-2xl border border-[hsl(var(--border))] bg-background/70 p-4'>
              The extension registers this page as a builtin component using `componentId: extension-harbor-page`.
            </div>
            <div className='rounded-2xl border border-[hsl(var(--border))] bg-background/70 p-4'>
              The extension also provides a menu item with `pageType: builtin`, so routing stays inside the host shell.
            </div>
            <div className='rounded-2xl border border-[hsl(var(--border))] bg-background/70 p-4'>
