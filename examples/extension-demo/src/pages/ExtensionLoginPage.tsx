...
const featureCards = [
  {
    ...
    description: 'This login page is provided by the extension itself, not by host-side loginUi field overrides.',
    icon: ShieldCheck
  },
  {
    title: 'System page override',
    description: 'The host still owns the `/auth/login` route, while the extension maps that route to a custom builtin page.',
    icon: Layers3
  },
  {
        ...
        <div className='hidden rounded-[2rem] border border-white/40 bg-white/70 p-10 shadow-2xl backdrop-blur-xl lg:flex lg:flex-col lg:justify-between'>
          <div className='space-y-8'>
            ...
            <div className='space-y-4'>
              ...
              <h1 className='max-w-2xl text-5xl font-semibold leading-tight text-slate-950'>A full login page delivered by the extension package.</h1>
              <p className='max-w-2xl text-lg leading-8 text-slate-600'>
                The host shell still owns routing, auth state, and navigation. This page proves that an extension can replace
