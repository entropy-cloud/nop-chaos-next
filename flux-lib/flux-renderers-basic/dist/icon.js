...
export function IconRenderer(props) {
    ...
    const IconComp = Icon;
    return (_jsx(IconComp, { className: classNames('nop-icon', `nop-icon--${icon}`, props.meta.className), "data-icon": icon, "data-testid": props.meta.testid || undefined, size: 16, strokeWidth: 1.8, "aria-hidden": "true", focusable: "false" }));
}
