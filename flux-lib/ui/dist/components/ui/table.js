...
function TableBody({ className, ...props }) {
    return (_jsx("tbody", { "data-slot": "table-body", className: cn('nop-table ', '[&_tr:last-child]:border-0', className), ...props }));
}
function TableFooter({ className, ...props }) {
    return (_jsx("tfoot", { "data-slot": "table-footer", className: cn('nop-table ', 'border-t bg-muted/50 font-medium [&>tr]:last:border-b-0', className), ...props }));
}
...
export { Table, TableHeader, TableBody, TableFooter, TableHead, TableRow, TableCell, TableCaption, getTableRowClassName, };
