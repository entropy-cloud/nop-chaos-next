...
const AlertDialogZIndexContext = React.createContext(undefined);
...
function AlertDialogOverlay({ className, ...props }) {
    ...
    return (_jsx(AlertDialogPrimitive.Backdrop, { "data-slot": "alert-dialog-overlay", className: cn('fixed inset-0 isolate bg-surface-overlay duration-100 supports-backdrop-filter:backdrop-blur-xs data-open:animate-in data-open:fade-in-0 data-closed:pointer-events-none data-closed:animate-out data-closed:fade-out-0', className), style: zIndex === undefined ? undefined : { zIndex }, ...props }));
}
function AlertDialogContent({ className, size = 'default', ...props }) {
    const zIndex = useGlobalZIndex();
    return (_jsx(AlertDialogPortal, { children: _jsxs(AlertDialogZIndexContext.Provider, { value: zIndex, children: [_jsx(AlertDialogOverlay, {}), _jsx(AlertDialogPrimitive.Popup, { "data-slot": "alert-dialog-content", "data-size": size, className: cn('group/alert-dialog-content fixed top-1/2 left-1/2 grid w-full -translate-x-1/2 -translate-y-1/2 gap-4 rounded-xl bg-popover p-4 text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none data-[size=default]:max-w-xs data-[size=sm]:max-w-xs data-[size=default]:sm:max-w-sm data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95', className), style: { zIndex }, ...props })] }) }));
}
