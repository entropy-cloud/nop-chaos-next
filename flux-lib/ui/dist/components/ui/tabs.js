...
const TabsList = React.forwardRef(function TabsList({ className, variant = "default", ...props }, ref) {
    return (_jsx(TabsPrimitive.List, { ref: ref, "data-slot": "tabs-list", "data-variant": variant, className: cn(tabsListVariants({ variant }), className), ...props }));
});
...
const TabsContent = React.forwardRef(function TabsContent({ className, ...props }, ref) {
    return (_jsx(TabsPrimitive.Content, { ref: ref, "data-slot": "tabs-content", className: cn("flex-1 outline-none", className), ...props }));
});
