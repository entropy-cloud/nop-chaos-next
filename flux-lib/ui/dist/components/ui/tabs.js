...
function Tabs({ className, ...props }) {
    return (_jsx("div", { className: cn("group/tabs flex gap-2", className), ...props }));
}
...
const TabsList = React.forwardRef(function TabsList({ className, variant = "default", ...props }, ref) {
    return (_jsx("div", { ref: ref, className: cn(tabsListVariants({ variant }), className), ...props }));
});
...
const TabsContent = React.forwardRef(function TabsContent({ className, ...props }, ref) {
    return (_jsx("div", { ref: ref, className: cn("flex-1 outline-none", className), ...props }));
});
