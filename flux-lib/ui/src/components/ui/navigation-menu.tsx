...
function NavigationMenu({
  ...
  return (
    <NavigationMenuPrimitive.Root
      ...
      className={cn('nop-navigation-menu ',
...
function NavigationMenuList({
  ...
  return (
    <NavigationMenuPrimitive.List
      ...
      className={cn('nop-navigation-menu ','group flex flex-1 list-none items-center justify-center gap-0', className)}
      {...props}
    />
  );
}
...
function NavigationMenuItem({
  ...
  return (
    <NavigationMenuPrimitive.Item
      ...
      className={cn('nop-navigation-menu ','relative', className)}
      {...props}
    />
  );
}
...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      className={cn('nop-navigation-menu ',navigationMenuTriggerStyle(), 'group', className)}
      {...props}
    >
      {children}{' '}
      <ChevronDownIcon
