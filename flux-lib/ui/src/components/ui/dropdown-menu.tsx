...
function DropdownMenuPositioner({
  ...
  return (
    <MenuPrimitive.Positioner
      ...
      className={cn('nop-dropdown-menu ','isolate outline-none', className)}
      style={{ zIndex, ...style }}
      {...props}
    />
  );
...
function DropdownMenuPopup({ className, ...props }: MenuPrimitive.Popup.Props) {
  return (
    <MenuPrimitive.Popup
      ...
      className={cn('nop-dropdown-menu ',
...
function DropdownMenuSeparator({ className, ...props }: MenuPrimitive.Separator.Props) {
  return (
    <MenuPrimitive.Separator
      ...
      className={cn('nop-dropdown-menu ','-mx-1 my-1 h-px bg-border', className)}
      {...props}
    />
  );
}
