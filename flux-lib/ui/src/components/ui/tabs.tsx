...
function Tabs({ className, ...props }: React.ComponentProps<'div'>) {
  return <div className={cn('group/tabs flex gap-2', className)} {...props} />;
}
...
const TabsList = React.forwardRef<
  HTMLDivElement,
  React.ComponentPropsWithoutRef<'div'> & VariantProps<typeof tabsListVariants>
...
const TabsContent = React.forwardRef<HTMLDivElement, React.ComponentPropsWithoutRef<'div'>>(
  function TabsContent({ className, ...props }, ref) {
    return <div ref={ref} className={cn('flex-1 outline-none', className)} {...props} />;
  },
);
