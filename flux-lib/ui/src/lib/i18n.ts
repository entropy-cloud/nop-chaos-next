const messages: Record<string, string> = {
  ...
  'flux.page.asideToggle': 'Toggle aside',
  'flux.page.remark': 'Remark',
  'flux.pagination.morePages': 'More pages',
  'flux.pagination.first': 'First page',
  'flux.pagination.last': 'Last page',
  'flux.pagination.previous': 'Previous page',
  'flux.pagination.next': 'Next page',
