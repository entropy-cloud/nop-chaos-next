...
function TabContextMenu({
  ...
  const top = Math.max(
    VIEWPORT_PADDING,
    Math.min(menuState.y, window.innerHeight - MENU_HEIGHT - VIEWPORT_PADDING),
  );
  const menuStyle =
    menuState.align === 'right'
      ...
      : {
          left: Math.max(
            VIEWPORT_PADDING,
            Math.min(menuState.x, window.innerWidth - MENU_WIDTH - VIEWPORT_PADDING),
          ),
          top,
        };
        ...
        <div className="flex h-12 items-center gap-3 px-4 py-2 sm:px-6">
          <div className="flex min-w-0 flex-1 items-center gap-2">
            ...
            <div
              ...
              className="tab-strip min-w-0 flex-1 overflow-x-auto overflow-y-hidden scroll-smooth"
            >
          ...
          <div className="flex shrink-0 items-center gap-1">
            ...
            {onToggleFullscreen ? (
              <Button
                ...
                aria-label={
                  isFullscreen
                    ? t('tabsBar.exitFullscreenWorkspace')
                    : t('tabsBar.enterFullscreenWorkspace')
                }
