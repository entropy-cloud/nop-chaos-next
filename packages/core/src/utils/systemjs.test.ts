...
describe('systemjs utils', () => {
  beforeEach(() => {
    delete (globalThis as typeof globalThis & { System?: { import: (url: string) => Promise<unknown> } }).System
  })
  ...
  it('loads system bundles through System.import', async () => {
    ...
    await expect(loadRemoteComponent('/plugins/plugin-demo.system.js?t=2')).resolves.toBe(Component)
